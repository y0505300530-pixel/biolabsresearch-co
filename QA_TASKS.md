...
| P2 | v2.99c Soft-QA (Red 1 + calculators + Red 3): bacteriostatic blog/compare third-person, RUO above fold, no usage-scenario table, banned phrases grep-zero; calculator CTAs/FAQs/hub; hero trust no 45K+/1,200/SKU count. PDP stars left alone. | pages | open |
