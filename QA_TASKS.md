...
| P6 | v2.99e1 G3-R public rename Soft-QA: catalog/PDP gold-band **G3-R**; URL `/products/g3-r`; alt `G3-R {dose} research vial`; no public Retatrutide/R3TA on band/alt/URL; gold-band assets `vial-g3-r.webp` (+10/20/50) under `html/media/`; sitewide stamp **2.99e1**. | pages | open |
