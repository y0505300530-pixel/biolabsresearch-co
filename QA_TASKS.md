...
| P6 | v2.99f1 mobile catalog 2-col + card density through 320px. Soft-QA homepage @320/375/390: 2 columns × 2 rows visible in ~700px viewport (not 1-col, not 99×640 skyscraper cards). Toolbar filters 2×2. Quote/G3-R/abandon untouched. **f SEO pages can Soft-QA in parallel after this.** | pages | open |
