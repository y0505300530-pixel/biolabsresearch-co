...
function addMoreHtml(cart){
  ...
  list.forEach(function(p){
    ...
    html += '<div class="cart-addcard">' +
      '<a href="/products/' + p.slug + '.html"><img src="/media/vial-' + p.slug + '.png?v=180" alt="' + p.name + '" width="84" height="64"></a>' +
...
function addSuggest(slug, name, price, mg){
  ...
  if (typeof getCart === 'function') {
    ...
    else c.push({name:name, price:price, qty:1, slug:slug, mg:(mg || undefined), imageUrl:'/media/vial-'+(slug)+'.png?v=180'});
  ...
  if (typeof cart !== 'undefined') {
    ...
    else cart.push({name:name, price:price, qty:1, slug:slug, mg:(mg || undefined), imageUrl:'/media/vial-'+(slug)+'.png?v=180'});
