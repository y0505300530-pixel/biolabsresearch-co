...
Visible site tip is **v2.99f1** (`catalog-mobile-2col-compact`) on top of **v2.99f** (`seo-level1-compare-faq`) /
**v2.99e3** (`mobile-catalog-search`) / **v2.99e2** / **v2.99e1** (`g3-r-public-rename`) /
**v2.99e** (`abandoned-checkout`)
...
**G3-R (v2.99e1):** Public catalog name is **G3-R** only (`/products/g3-r`; gold-band **G3-R**). Old retatrutide/r3ta/reta paths 301. Do not resurrect `html/products/retatrutide.html`. Soft-QA Gate 0 stamp for this tip is **v2.99f**.
