...
Visible site tip is **v2.99g** (`hub-spoke-dynamic-coa`) on top of **v2.99f** (`seo-level1-compare-faq`) /
**v2.99e3** (`mobile-catalog-search`) / **v2.99e2** / **v2.99e1** (`g3-r-public-rename`) /
**v2.99e** (`abandoned-checkout`) and Quote mode (**v2.99d**) while CRM `paymentsEnabled:false`.
v2.99c2 (`reconstitution-faq`) remains the version base under d. Merge of g is held until v2.99f1.
...
**G3-R (v2.99e1, kept under g):** Public catalog name is **G3-R** only (`/products/g3-r`; gold-band **G3-R**). Old retatrutide/r3ta/reta paths 301. Do not resurrect `html/products/retatrutide.html`. Soft-QA Gate 0 stamp for this tip is **v2.99g**.
